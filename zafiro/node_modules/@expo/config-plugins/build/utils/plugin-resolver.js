...
=======
      const learnMoreLink = `Learn more: https://docs.expo.io/guides/config-plugins/#creating-a-plugin`; // If the plugin reference is a node module, and that node module has a syntax error, then it probably doesn't have an official config plugin.
...
=======
  ...
  if (typeof plugin !== 'function') {
    const learnMoreLink = `Learn more: https://docs.expo.io/guides/config-plugins/#creating-a-plugin`; // If the plugin reference is a node module, and that node module does not export a function then it probably doesn't have a config plugin.
