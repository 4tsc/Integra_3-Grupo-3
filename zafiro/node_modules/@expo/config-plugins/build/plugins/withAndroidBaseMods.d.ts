...
export declare function getAndroidIntrospectModFileProviders(): Omit<AndroidDefaultProviders, 'dangerous' | 'projectBuildGradle' | 'settingsGradle' | 'appBuildGradle' | 'mainActivity'>;
>>>>>>> apetey
export {};
